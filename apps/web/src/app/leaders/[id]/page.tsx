...
export default async function LeaderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      {/* Sticky follow CTA */}
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-border bg-[rgba(5,11,23,0.8)] px-4 py-3 backdrop-blur-xl sm:hidden">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 hidden justify-center sm:flex">
        <div className="pointer-events-auto rounded-full border border-border bg-surface/95 p-1.5 shadow-lg backdrop-blur">
